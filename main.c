...
int main( int argc, char *argv[]){
  ...
  int err_0, err_1, idx_1,idx_0, fd_0, fd_1,retval ,devidx_0 = 0, devidx_1=0;
  ...
  while(1){
    ...
    cb_0 = nl_cb_alloc(iw_debug ? NL_CB_DEBUG : NL_CB_DEFAULT);
    s_cb_0 = nl_cb_alloc(iw_debug ? NL_CB_DEBUG : NL_CB_DEFAULT);
    cb_1 = nl_cb_alloc(iw_debug ? NL_CB_DEBUG : NL_CB_DEFAULT);
    s_cb_1 = nl_cb_alloc(iw_debug ? NL_CB_DEBUG : NL_CB_DEFAULT);
